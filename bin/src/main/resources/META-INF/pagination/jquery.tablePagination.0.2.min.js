 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src=paginacion_first_url,  
			prevArrow : (new Image()).src=paginacion_prev_url,
			lastArrow : (new Image()).src=paginacion_last_url,
			nextArrow : (new Image()).src=paginacion_next_url,
			rowsPerPage : 10,
			currPage : 1,
