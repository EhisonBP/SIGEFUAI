...
@RooJavaBean
@RooToString
@RooEntity(finders = { "findActividadActuacionsByCodigoActuacion", "findActividadActuacionsByActividadActuacion" })
public class ActividadActuacion implements ObjetoComentable, Serializable {

    private static final Logger logger = Logger.getLogger(ActividadActuacion.class);
    ...
    public String getCodigoCompleto() {
        if (this.actividadActuacion != null) {
            if ((this instanceof ActividadGeneral) && ((this.actividadActuacion instanceof ActividadGeneral) == false) && (this.objetivoAMitigar != null)) {
                return this.actividadActuacion.getCodigoCompleto() + "." + this.objetivoAMitigar.getReferencia() + "." + this.getCodigo();
            }
            else{
                return this.actividadActuacion.getCodigoCompleto() + "." + this.getCodigo();
            }
        } 
        else {
            if (this.objetivoAMitigar != null){
                return this.getCodigoActuacion().getCodigoCompleto() + "-" + this.objetivoAMitigar.getReferencia() + "." + this.getCodigo();
            }
            else{
                //return this.getCodigoActuacion().getCodigoCompleto() + "-" + this.getCodigo();
    ...
    public static final Comparator compararActividades = new Comparator() {
        ...
        public int compare(Object arg0, Object arg1) {
            ...
            return actividad1.getCodigoCompleto().compareTo(actividad2.getCodigoCompleto());
        }
    };
