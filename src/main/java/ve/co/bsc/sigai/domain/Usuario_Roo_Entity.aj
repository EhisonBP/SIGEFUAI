...
privileged aspect Usuario_Roo_Entity {
    ...
    public void Usuario.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Usuario attached = this.entityManager.find(Usuario.class, this.id);
    ...
    public static long Usuario.countUsuarios() {
        return (Long) entityManager().createQuery("select count(o) from Usuario o").getSingleResult();
    }
