...
@RooWebScaffold(path = "clasificacionriesgo", automaticallyMaintainView = true, formBackingObject = ClasificacionRiesgo.class)
@RequestMapping("/clasificacionriesgo/**")
@Controller
public class ClasificacionRiesgoController {
}
