...
@RooWebScaffold(path = "datosorganismoente", automaticallyMaintainView = true, formBackingObject = DatosOrganismoEnte.class)
@RequestMapping("/datosorganismoente/**")
@Controller
public class DatosOrganismoEnteController {
}
